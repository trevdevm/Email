...
const validationRules = () => {
    return [
        check('name').isLength({ min: 2, max: 25 }).withMessage('Min of 2 and max of 25 characters in name.').isAlphanumeric().withMessage('Only letters and numbers allowed in name.'),
